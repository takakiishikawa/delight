            ...
            <TabContext value={tabValue}>
                ...
                <TabPanel value="1">
                    ...
                    <div id="addMeditation">
                        ...
                        <TextField id="meditationOutlined" label="meditation" variant="outlined" onChange={onChangeMeditation} />
                        </Box><br></br>
                        <Button type="button" onClick={onClickMeditation} variant="contained" endIcon={<SendIcon />}>Send</Button>
                    </div>
                    </Typography>
                </TabPanel>
                <TabPanel value="2">
                    ...
                    <div id="addSleep">
                        <Box sx={{'& > :not(style)': { m: 1, width: '15ch' },}}>
                        <TextField id="sleepOutlined" label="sleep" variant="outlined" onChange={onChangeSleep} />
                        </Box><br></br>
                        <Button type="button" onClick={onClickSleep} variant="contained" endIcon={<SendIcon />}>Send</Button>
                    </div>
                    </Typography>
                </TabPanel>
                <TabPanel value="3">
                    ...
                    <div id="addWeight">
                        <Box sx={{'& > :not(style)': { m: 1, width: '15ch' },}}>
                        <TextField id="weightOutlined" label="meditation" variant="outlined" onChange={onChangeWeight} />
                        </Box><br></br>
                        <Button type="button" onClick={onClickWeight} variant="contained" endIcon={<SendIcon />}>Send</Button>
                    </div>
                    </Typography>
                </TabPanel>
